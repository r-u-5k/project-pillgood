...
<>
  ...
  {loginUser ? (
      ...
      trigger={
        <span
          className="flex items-center font-Pretendard text-md text-left tracking-tight text-gray-900 cursor-pointer font-semibold"
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="w-full h-full flex flex-row justify-center">
                          <div
                            className={`w-[570px] h-[80px] bg-gray-100 rounded-xl flex flex-row ${
                              survey.symptomType == "혈관" &&
                          ...
                          >
                            <span className="w-[48px] h-[48px] my-auto ml-[15px]">
                              <img
                                src={blood}
                                alt=""
                                className="flex justify-center inline"
                              />
                            </span>
                            <span
                              className={`ml-[15px] flex items-center text-xl text-[20px] font-normal hover: cursor-pointer `}
                            >
                              혈관 · 혈액순환
                            </span>
                          </div>
                          ...
                          >
                            <span className="w-[48px] h-[48px] my-auto ml-[15px]">
                              <img
                                src={woman}
                                alt=""
                                className="flex justify-center inline m-auto pt-[7px]"
                              />
                            </span>
                            <span
                              className={`ml-[15px] flex items-center text-xl text-[20px] font-normal hover: cursor-pointer `}
                        ...
                        <div className="w-full h-[100px] flex justify-center">
                          <Button
                            ...
                            className="rounded-2xl bg-gray-900 text-white font-semibold m-auto w-[150px] h-[50px] hover:bg-gray-900"
                            variant="default"
                          >
                            추천받기
                          </Button>
