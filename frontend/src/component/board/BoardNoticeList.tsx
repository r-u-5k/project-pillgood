...
import { Table, Select, Pagination } from "semantic-ui-react";
import { boardNoticeList } from "@/api/boardApi";
import { useRecoilValue } from "recoil";
import { userState } from "@/recoil/atoms";
import { Button } from "@/components/ui/button";

export const BoardNoticeList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const responseJsonObject = await boardNoticeList();
